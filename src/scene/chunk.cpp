...
void Chunk::creatCube(glm::vec3 pos,std::vector<glm::vec4>(&vert_data),int type){
    ...
    int y=pos.y;
    int z=pos.z;
    float px=x+this->pos.x;
    float py=y+this->pos.y;
    float pz=z+this->pos.z;
    ...
    glm::vec4 bottomUV(2,0,2,0);
       if(type==Water){                               //water
           ...
           sideUV=glm::vec4(12,0,0.5,0);
            topUV=glm::vec4(4,11,1,0);                          //Flower
           bottomUV=glm::vec4(2,4,1,0);
       }
       else if(type==Grass){
           sideUV=glm::vec4(7,2,1,3);
           topUV=glm::vec4(4,11,1,3);                          //Grass
           bottomUV=glm::vec4(4,2,1,3);
       }

       else if(type==Snow){
           sideUV=glm::vec4(4,4,0.3,0);
            topUV=glm::vec4(2,4,0.3,0);                          //Snow
           bottomUV=glm::vec4(2,0,1,0);
       }
       else if(type==SnowFlake){
           sideUV=glm::vec4(11,0,1,0);
            topUV=glm::vec4(11,0,1,0);                          //SnowFlake
           ...
           sideUV=glm::vec4(2,11,0.1,0);
           topUV=glm::vec4(2,11,0.1,0);                          //wood
           bottomUV=glm::vec4(2,11,0.1,0);
       }
   ...
   vert_data.push_back(glm::vec4(rightN,0));                          //normal
    ...
    //Top face
    if((y+1>=CHUNK_SIZE||active[x][y+1][z]==false)&&type!=Flower){
   ...
   vert_data.push_back(topT);                              //TANGENT
    ...
    //Bottom face
    if((y-1<0||active[x][y-1][z]==false)&&type!=Flower){
