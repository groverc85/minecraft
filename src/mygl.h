...
private:
    ...
    QSound* SnowPlayer = new QSound("../final2/sound/person_running_on_snow.wav");
    QSound* WaterPlayer = new QSound("../final2/sound/walking_through_and_splashing_in_water.wav");
    ...
    PlusMark geom_plus;   //add by Yi Huang
    int timecount;
    float velocity;
    bool isJumping;
